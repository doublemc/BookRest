...
//    PublicationYear anyYear = new PublicationYear(ANY_PUBLICATION_YEAR);
//
//    // when
//    Book book = new Book(new Isbn(ANY_ISBN), new Title(ANY_TITLE), new Author(ANY_AUTHOR),
//        new Genre(ANY_GENRE), new PublicationYear(ANY_PUBLICATION_YEAR), ANY_PRICE);
//    // then
...
//    assertThat(book.getPublicationYear()).isEqualTo(anyYear);
//  }
//
//}